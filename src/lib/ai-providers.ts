  ...
  google: {
    ...
    models: [
      ...
      },
      {
        ...
        contextLength: 1048576,
        description: "Fast multimodal model (Note: For vision/images, use Flash Experimental)",
        pricing: { inputPer1M: 0.10, outputPer1M: 0.40 },
      ...
      },
      {
        ...
        contextLength: 1048576,
        description: "Full multimodal support including vision, image understanding, and generation",
        pricing: { inputPer1M: 0.0, outputPer1M: 0.0 },
        strengths: ["Full Vision Support", "Image Understanding", "Free tier", "Multimodal I/O"],
        recommended: true,
        maxOutputTokens: 8192,
      },
      {
      ...
      },
      {
        ...
        contextLength: 32000,
        description: "Full multimodal with native image generation, editing, and vision understanding",
        pricing: { inputPer1M: 0.10, outputPer1M: 0.40 },
        strengths: ["Full Vision Support", "Image generation", "Image editing", "Conversational"],
        recommended: false,
        capabilities: ["text-generation", "text-to-image", "image-editing", "image-understanding", "multimodal"],
        maxOutputTokens: 8192,
      },
    ],
  },
